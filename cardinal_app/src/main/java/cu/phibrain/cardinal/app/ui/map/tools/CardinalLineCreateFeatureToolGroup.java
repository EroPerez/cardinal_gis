 ...
 */
public class CardinalLineCreateFeatureToolGroup implements ToolGroup, OnClickListener, OnTouchListener, View.OnLongClickListener {
...
//    private Feature featureToContinue;
     ...
     */
    public CardinalLineCreateFeatureToolGroup(GPMapView mapView, UserMode userToolActive) {
            ...
            if (coordinatesList.size() > 1) {
                ...
                try {
                    if (this.userToolActive == UserMode.OBJECT_ADDITION) {
                        ...
                        editLayer.updateFeatureGeometry(null, lineGeometry, LibraryConstants.SRID_WGS84_4326);
                    }
