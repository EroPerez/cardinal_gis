...
public class MapviewActivity extends AppCompatActivity implements MtoAdapter.SelectedMto, IActivitySupporter, OnTouchListener, OnClickListener, OnLongClickListener, InsertCoordinatesDialogFragment.IInsertCoordinateListener, GPMapView.GPMapUpdateListener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        buttom_sheet_background = findViewById(R.id.buttom_sheet_background);
...
//        }
            ...
            RecyclerView recyclerView = bottomSheetView.findViewById(R.id.rvMto);
            ...
            try {
                ...
                GPDialogs.inputMessageDialog(this, message, proposedName, new TextRunnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            mapView.reloadLayer(MapObjectLayer.class, appContainer.MapObjecTypeActive.getId());
                ...
                if( appContainer.MapObjecTypeActive!=null) {
                    byte[] icon = appContainer.MapObjecTypeActive.getIconAsByteArray();
                    if (icon != null) {
