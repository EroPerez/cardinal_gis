 ...
 */
public class CardinalPolygonCreateFeatureToolGroup implements ToolGroup, OnClickListener, OnTouchListener, View.OnLongClickListener {
     ...
     * @param userToolActive
     */
    public CardinalPolygonCreateFeatureToolGroup(GPMapView mapView, UserMode userToolActive) {
        this.mapView = mapView;
        this.userToolActive = userToolActive;
            ...
            if (coordinatesList.size() > 2) {
                ...
                try {
                    if (this.userToolActive == UserMode.OBJECT_ADDITION) {
                        ...
                        editLayer.updateFeatureGeometry(null, polygonGeometry, LibraryConstants.SRID_WGS84_4326);
                    }
