...
public class CameraMapObjectActivity extends AbstractCameraActivity {
    protected double lon;
    protected double lat;
    protected double elevation;
    protected long mapObjectId = -1;
    ...
    public void onCreate(final Bundle icicle) {
        ...
        mapObjectId = extras.getLong(LibraryConstants.DATABASE_ID);
    ...
    public void doSaveData() {
        ...
        try {
            ...
            infoBuilder.append("mapObjectId: ").append(mapObjectId).append("\n");
            if (imageDataArray != null)
                infoBuilder.append("imageDataArray size: ").append(imageDataArray.length).append("\n");

            MapObjectImages image = new MapObjectImages(
                    null,
                    mapObjectId,
            ...
            Log.d("CameraMapObjectActivity", infoBuilder.toString());
