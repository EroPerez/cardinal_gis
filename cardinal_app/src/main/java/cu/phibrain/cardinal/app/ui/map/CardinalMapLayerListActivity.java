...
public class CardinalMapLayerListActivity extends AppCompatActivity implements ColorStrokeDialogFragment.IColorStrokePropertiesChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            showFragment(CardinalMapLayerListFragment.newInstance());
        }
