 ...
 */
public class CardinalPolygonCutExtendTool extends MapTool {
     ...
     */
    public CardinalPolygonCutExtendTool(GPMapView mapView, boolean doCut) {
        super(mapView);
        this.doCut = doCut;
            ...
            protected void onPostExecute(String response) { // on UI thread!
                ...
                if (response.startsWith("ERROR")) {//NON-NLS
                    ...
                    if (activeToolGroup != null) {
                        activeToolGroup.onToolFinished(cu.phibrain.cardinal.app.ui.map.tools.CardinalPolygonCutExtendTool.this);
                    }
                }
            }
