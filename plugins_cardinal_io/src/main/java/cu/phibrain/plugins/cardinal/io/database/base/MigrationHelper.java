...
public final class MigrationHelper {
    ...
    public static void migrate(Database db, List<Class<? extends AbstractDao<?, ?>>> daoClasses) {
        generateNewTablesIfNotExists(db, daoClasses);
        generateTempTables(db, daoClasses);
        dropAllTables(db, true, daoClasses);
        createAllTables(db, false, daoClasses);
    ...
    private static void generateNewTablesIfNotExists(Database db, List<Class<? extends AbstractDao<?, ?>>> daoClasses) {
    ...
    private static void dropAllTables(Database db, boolean ifExists, List<Class<? extends AbstractDao<?, ?>>> daoClasses) {
        reflectMethod(db, "dropTable", ifExists, daoClasses);
    }

    private static void createAllTables(Database db, boolean ifNotExists, List<Class<? extends AbstractDao<?, ?>>> daoClasses) {
     ...
     */
    private static void reflectMethod(Database db, String methodName, boolean isExists, List<Class<? extends AbstractDao<?, ?>>> daoClasses) {
