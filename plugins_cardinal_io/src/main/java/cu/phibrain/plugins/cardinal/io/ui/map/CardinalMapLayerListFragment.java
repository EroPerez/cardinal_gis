...
public class CardinalMapLayerListFragment extends Fragment implements IActivitySupporter, View.OnClickListener {
    ...
    public static CardinalMapLayerListFragment newInstance() {
        return new CardinalMapLayerListFragment();
    }
