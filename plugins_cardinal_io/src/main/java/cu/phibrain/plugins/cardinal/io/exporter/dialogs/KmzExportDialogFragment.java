...
package cu.phibrain.plugins.cardinal.io.exporter.dialogs;
...
import cu.phibrain.plugins.cardinal.io.exporter.kml.CardinalKmzExport;
        ...
        new AsyncTask<String, Void, String>() {
            protected String doInBackground(String... params) {
                ...
                try {
                     ...
                     * get mapobjects
                     */
                    List<MapObject> objectList =  MapObjectOperations.getInstance().getAll();
                    for (MapObject object : objectList) {
                        if (isInterrupted) break;
                        kmlRepresenterList.add(object);
                        hasAtLeastOne = true;
                    }
                    /*
                     * add pictures
                     */
                   List<MapObjectImages> imagesList = MapObjectImagesOperations.getInstance().getAll();
                    ...
                    if (projectName == null) {
                        projectName = "cardinalpaparazzi_kmz_";//NON-NLS
                    } else {
                    ...
                    CardinalKmzExport export = new CardinalKmzExport(null, kmlOutputFile);
